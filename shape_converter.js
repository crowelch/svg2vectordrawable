...
function convertCircle(circleTag) {
...
function convertEllipse(ellipseTag) {
...
function convertPolygon(polylineTag, isPolyline) {
...
exports.convertEllipse = convertEllipse;
